            ...
            <div id="content-wrapper">
                ...
                <div id="content-container">
                    <div class="add-patient">
                        <input type="button" value="Cadastrar" onclick="window.location.href = 'paciente-cadastro.jsp'; return false;" class="btn-primary"/>
                    </div>
                        ...
                        <table class="tades-table" cellspacing="0">
                            ...
                            <tbody>
                                <c:forEach var="paciente" items="${PACIENTES}">
                                    ...
                                    <c:url var="link" value="PacienteControllerServlet">
                                        <c:param name="command" value="LOAD" />
                                        <c:param name="pacienteId" value="${paciente.id}" />
                                    </c:url>
