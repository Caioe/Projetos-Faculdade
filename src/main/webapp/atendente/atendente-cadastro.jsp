            ...
            <div id="content-wrapper">
                ...
                <div id="content-container">
                    ...
                    <div class="form-session">
                        <form action="FuncionarioControllerServlet" method="GET">

                            <input type="hidden" name="command" value="CREATE ATTENDANT" />
                    ...
                    <p style="padding: 0px 410px;">
                        <a href="FuncionarioControllerServlet">Voltar a lista de Funcionários</a>
                    </p>
