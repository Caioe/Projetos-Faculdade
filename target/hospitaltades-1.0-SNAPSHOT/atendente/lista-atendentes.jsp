        ...
        <div id="content-wrapper">
            ...
            <div id="content-container">
                <div class="add-patient">
                    <input type="button" value="Cadastrar" onclick="window.location.href = 'atendente/atendente-cadastro.jsp'; return false;" class="btn-primary"/>
                </div>
                    ...
                    <table class="tades-table" cellspacing="0">
                        ...
                        <tbody>
                            <c:forEach var="atendente" items="${ATENDENTES}">
                                ...
                                <c:url var="link" value="AtendenteControllerServlet">
                                    <c:param name="command" value="LOAD ATTENDANT" />
                                    <c:param name="atendenteId" value="${atendente.idAtendente}" />
                                </c:url>

                                <c:url var="deleteLink" value="AtendenteControllerServlet">
                                    <c:param name="command" value="DELETE ATTENDANT" />
                                    <c:param name="atendenteId" value="${atendente.idAtendente}" />
                                </c:url>
