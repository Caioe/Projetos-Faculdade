                ...
                <div id="content-container">
                    ...
                    <div class="form-session">
                        <form action="MedicoControllerServlet" method="POST">
                            ...
                            <input type="hidden" name="command" value="UPDATE MEDIC" />

                            <input type="hidden" name="medicoId" value="${MEDICO.idMedico}" />

                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="nome">Nome</label>
                                    <input type="text" class="form-control" value="${MEDICO.nome}" name="nome" placeholder="Nome" />

                                </div>
                                <div class="form-group col-md-6">
                                    <label for="sobrenome">Sobrenome</label>
                                    <input type="text" class="form-control" value="${MEDICO.sobrenome}"name="sobrenome" placeholder="Sobrenome" />
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control-select" name="sexo" value="${MEDICO.sexo}" id="sexo">
