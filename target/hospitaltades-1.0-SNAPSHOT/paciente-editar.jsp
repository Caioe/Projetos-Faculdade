            ...
            <div id="content-wrapper">
                ...
                <div id="content-container">
                    ...
                    <div class="form-session">
                        <form action="PacienteControllerServlet" method="POST">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="nome" value="${PACIENTE.nome}" name="nome" placeholder="Nome">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="sobrenome">Sobrenome</label>
                                    <input type="text" class="form-control" id="sobrenome" value="${PACIENTE.sobrenome}" name="sobrenome" placeholder="Sobrenome">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" value="${PACIENTE.cpf}" id="cpf" name="cpf">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="cep">Data de Nascimento</label>
                                    <input type="text" class="form-control" id="dataNasc" value="${PACIENTE.dataNasc}" name="dataNasc">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="sexo">Sexo</label>
                                    <select class="form-control-select" name="sexo" value="${PACIENTE.sexo}" id="sexo">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="email" class="form-control" id="email" value="${PACIENTE.email} "name="email" placeholder="Email">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="contato">Telefone / Contato</label>
                                    <input type="text" class="form-control" id="contato" value="${PACIENTE.contato}" name="contato" placeholder="1199000..." min="10" max="11">
                                </div>
                            </div>
                    ...
                    <p style="padding: 0px 410px;">
                        <a href="PacienteControllerServlet">Voltar a lista de Pacientes</a>
                    </p>
