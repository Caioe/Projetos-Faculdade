            ...
            <div id="content-wrapper">
                ...
                <div id="content-container">
                    ...
                    <div class="form-session">
                        <form action="AtendenteControllerServlet" method="POST">

                            <input type="hidden" name="command" value="UPDATE ATTENDANT" />
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" value="${ATENDENTE.nome}" name="nome" placeholder="Nome" />

                                </div>
                                <div class="form-group col-md-6">
                                    <label for="sobrenome">Sobrenome</label>
                                    <input type="text" class="form-control" value="${ATENDENTE.sobrenome}"name="sobrenome" placeholder="Sobrenome" />
                                </div>
                            </div>
